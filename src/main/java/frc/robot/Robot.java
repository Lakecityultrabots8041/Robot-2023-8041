...
public class Robot extends TimedRobot {
  ...
  private final MotorControllerGroup leftgroup = new MotorControllerGroup(driveTopLeft,driveLeftfront, driveLeftrear);
  private final MotorControllerGroup rightgroup = new MotorControllerGroup(driveTopRight,driveRightfront,driveRightrear);
  private final DifferentialDrive diff = new DifferentialDrive(leftgroup, rightgroup);
  /**
  ...
  public void teleopPeriodic() { 
    diff.arcadeDrive(OI.deadband(joy.getRawAxis(1))* Constants.DriveTrain.speedmult,OI.deadband(joy.getRawAxis(0)));
